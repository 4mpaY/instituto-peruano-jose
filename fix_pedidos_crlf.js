...
// 2. States
const stateRegex = /  const \[nroPedido, setNroPedido\] = useState\(''\)\r?\n  const \[nombre, setNombre\] = useState\(''\)/;
if (!content.includes('cursoFiltro')) {
...
const startMarker2 = "<div className='flex justify-between flex-col items-start xl:flex-row xl:items-start p-6 border-bs gap-4'>";
